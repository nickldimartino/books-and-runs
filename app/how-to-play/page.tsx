...
export default function HowToPlayPage() {
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col gap-8 px-6 py-12">
      ...
      <section className="flex flex-col gap-2 text-sm leading-relaxed text-[var(--muted)]">
        <h2 className="text-base font-semibold text-[var(--heading)]">
          What&apos;s different from playing at a table
        </h2>
        <p>A few house rules from playing with real cards aren&apos;t part of this app.</p>
        <ul className="ml-5 list-disc space-y-1">
          <li>
            ...
            pile, without it becoming their turn. That relies on everyone secretly watching their
            own hand so they can jump in at the right moment — hard to pull off when everyone
            shares one screen and the AI plays its own turns automatically, so it&apos;s left out.
          </li>
          <li>
            ...
            as buying the discard — it needs a private hand to watch, so it&apos;s not here either.
          </li>
          <li>
