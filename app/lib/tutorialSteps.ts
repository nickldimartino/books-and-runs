...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    target: "hand",
    title: "Laying off",
    body: "With your contract melded, you can add single cards onto any meld on the table — yours or an opponent's. Watch for a gold ↓ badge on a card: it means that card fits somewhere. Nothing qualifies this turn, but keep an eye out. You can turn the hint off in Settings.",
    gate: { type: "tap" },
  },
  {
    id: "discard",
