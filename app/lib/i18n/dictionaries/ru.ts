...
const ru = {
  ...
  "multiplayer.roundSummary.leftPenalty": "вышел · +{penalty} штрафа",
  ...
  "streakShield.dailyExplainer": "Каждые 7 дней подряд ты получаешь щит (держать можно до 2). Он незаметно закроет один пропущенный день.",
  "streakShield.weeklyExplainer": "Каждые 4 недели подряд ты получаешь щит. Он незаметно закроет одну пропущенную неделю.",
