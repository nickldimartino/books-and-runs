...
const ru = {
  ...
  "signIn.agreePrefix": "Продолжая, ты соглашаешься с нашими",
  "signIn.agreeAnd": "и",
  "signIn.privacyPolicy": "Политикой конфиденциальности",
  ...
  "account.delete.bodyPrefix":
    "Пока нет удаления аккаунта самостоятельно. Чтобы удалить аккаунт и всё, что с ним связано, — статистику, историю игр, достижения, отображаемое имя, друзей и сетевые игры, — напиши на",
  "account.delete.bodySuffix": "с адреса, указанного в твоём аккаунте.",
  ...
  "terms.app.bodyPrefix":
    "Books & Runs — карточная игра для игры за одним устройством по очереди и одиночных партий против ИИ-соперников. Она полностью работает офлайн и без аккаунта. Создание аккаунта необязательно: он открывает статистику на всех устройствах, достижения и уровень аккаунта — о том, что это значит, читай в нашей",
  ...
  "terms.termination.body":
    "Ты можешь в любой момент прекратить пользоваться приложением или удалить аккаунт (как это сделать — см. в Политике конфиденциальности). Мы можем приостановить или удалить аккаунты, нарушающие эти условия.",
  "terms.changes.title":
    "Изменения условий",
  "terms.changes.body":
  ...
  "privacy.overview.body":
    "Books & Runs — карточная игра, в которую можно играть полностью офлайн, на одном устройстве и без аккаунта. Эта политика объясняет, что происходит, если ты решишь создать аккаунт, и подтверждает, что мы не собираем никогда.",
  ...
  "privacy.account.item.friendsSuffix":
    "и список друзей: какие аккаунты ты добавил в друзья и какие запросы в друзья отправлены или получены. Когда ты добавляешь друга, твоё отображаемое имя становится видно ему, а его — тебе.",
  "privacy.account.item.multiplayer":
    "Данные сетевых игр: для каждой пошаговой игры, которую ты начинаешь или к которой присоединяешься, — другие участники, рассадка, чей сейчас ход, размеры рук, счёт и итоговый результат. Полное состояние игры (включая перемешанную колоду и руку каждого игрока) хранится на стороне сервера и показывается игроку только как его собственный вид — руку другого игрока ты не увидишь.",
  ...
  "privacy.account.outro":
    "Мы не требуем настоящего имени и не собираем данные о местоположении, контактах, фотографиях или разрешениях устройства. В приложении нет рекламы, а также аналитических и отслеживающих SDK.",
