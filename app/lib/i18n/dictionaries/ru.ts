...
const ru = {
  ...
  "terms.termination.body":
    "Вы можете в любой момент прекратить пользоваться приложением или удалить аккаунт (как это сделать — см. в Политике конфиденциальности). Разработчик может приостановить, ограничить или удалить аккаунт либо удалить контент, если они нарушают эти условия — например, при жульничестве, травле, оскорбительных именах или фотографиях либо попытках атаковать или перегрузить сервис, — и может сделать это без предварительного уведомления, когда это необходимо для защиты сервиса или других игроков. Если вы считаете, что это произошло по ошибке, свяжитесь с нами.",
  "terms.law.title":
    "Применимое право",
  "terms.law.body":
  ...
  "privacy.account.item.push":
    "Если вы включите уведомления — push-подписку вашего браузера (адрес и ключи шифрования, предоставленные push-сервисом вашего браузера), чтобы мы могли присылать вам уведомления «ваш ход», о друзьях и напоминания о Раскладе дня. Это отключено, пока вы не согласитесь, и вы можете отключить это в любой момент в приложении либо в настройках браузера или устройства.",
  ...
  "privacy.export.bodyMiddle":
    "— она в любой момент выдаёт данные, связанные с вашим аккаунтом (профиль, статистику, историю, достижения, настройки, сохранения, друзей и записи о сетевых играх), одним файлом, без необходимости делать запрос. Кнопки для самостоятельного удаления пока нет. Чтобы удалить аккаунт и всё, что с ним связано, — статистику, историю игр, прогресс достижений, профиль, друзей, клубы и сетевые игры, — напишите на",
  "privacy.export.bodySuffix":
    "с адреса, привязанного к аккаунту, и мы его удалим. При удалении аккаунта вы также исчезаете из списков друзей других игроков.",
  "privacy.retention.title":
    "Как долго мы храним данные",
  "privacy.retention.body":
    "Мы храним данные вашего аккаунта, пока существует ваш аккаунт. После вашей просьбы об удалении аккаунта мы стремимся удалить данные незамедлительно и в любом случае в разумный срок. Отчёты о сбоях автоматически удаляются примерно через 30 дней, а краткосрочные записи уведомлений и предотвращения злоупотреблений — не более чем через несколько недель. Анонимные счётчики использования не содержат персональных идентификаторов и хранятся до примерно 13 месяцев. Копии могут некоторое время оставаться в резервных копиях поставщика, пока не будут перезаписаны.",
  ...
  "privacy.rights.title":
    "Ваши права",
  "privacy.rights.body":
    "В зависимости от места вашего проживания вы можете иметь право на доступ к своим персональным данным, их исправление, удаление, получение копии в переносимом формате, возражение против отдельных видов обработки или требование их ограничить, а также на отзыв данного вами согласия. Многое из этого вы можете сделать сами: изменить профиль и настройки в приложении и скачать свои данные на странице аккаунта. По всем остальным вопросам, а также чтобы удалить аккаунт, напишите на указанный ниже адрес. Вы также вправе подать жалобу в местный надзорный орган по защите персональных данных. Прежде чем выполнить запрос, нам может потребоваться убедиться, что это действительно вы.",
