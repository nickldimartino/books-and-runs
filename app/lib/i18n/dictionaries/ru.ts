...
const ru = {
  ...
  "cosmeticReq.cat.layingOff": "Дополнение",
  ...
  "game.why.tooManyGroups": "Ты собрал больше групп, чем нужно в этом раунде — убери одну.",
  ...
  "safety.block.confirmBody":
    "Вы перестанете быть друзьями и не будете видеть друг друга: никаких заявок в друзья, приглашений, реакций и строк в рейтинге в обе стороны. Человек не узнает об этом. Разблокировать можно в любой момент на странице аккаунта.",
  "safety.block.error":
  ...
  "safety.players.heading":
    "Игроки — пожаловаться или заблокировать",
  "safety.err.connect":
  ...
  "settings.notify.nudges":
    "Напоминания и реакции",
  "settings.notify.nudgesHint":
    "Когда тебе напоминают или реагируют в игре.",
  ...
  "privacy.account.item.emotes":
    "Быстрые реакции, которые вы отправляете во время многопользовательской игры (одна из фиксированного набора, никогда не свободный текст); их видят другие игроки этой игры, хранятся только последние для каждой игры.",
