 ...
 * are (see profileCosmetics.ts's AVATAR_FRAME_OPTIONS). "grandmaster" gets
 * a rotating conic-gradient ring instead of one flat color — the rarest
 * cosmetic in the whole system (every achievement category mastered)
 * reads as more than just another solid color. Renders children plain,
 * no wrapper at all, when there's no frame (or an unrecognized one). */
